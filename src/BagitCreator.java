...
public class BagitCreator {
	...
	/**
	 * Creates a bagit version 0.96 am then validates it, sending the results to standard out.
	 * 
	 * @param args
	 */
	public static void main(String[] args) 
	{
		 ...
		 if ( args.length < 2 )
		 {
			 ...
			 System.out.println( "\t the directory parameter is of type 'xxxx'/'yyyy' and must contain a directory named data." );
			 System.out.println( "\t the data directory MUST be named data and contain the files, ie images, batch file etc." );
			 System.out.println( "\t the parent directory containing 'yyyy' will end up containing the bagit file called, 'yyyy'.zip"    );
